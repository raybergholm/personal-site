...
import { Button, Cell } from "../components/foundation/Foundation";
...
const ContactLinks = () => (
  <Cell shrink>
    <hr />
    <Button link={GITHUB_PROFILE_URL} target="_blank" clear>
      <img src={githubLogo} alt="Find me on Github!" />
    </Button>
    <Button link={LINKEDIN_PROFILE_URL} target="_blank" clear>
